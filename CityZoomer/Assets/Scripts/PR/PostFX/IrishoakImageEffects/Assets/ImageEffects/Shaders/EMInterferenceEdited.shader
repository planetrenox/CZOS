...
Shader "Hidden/irishoak/ImageEffects/EMInterferenceEdited" {
	Properties {
		_MainTex ("-", 2D) = "" {}
	}
	...
	{	
	    ...
	    fixed4 col2 = tex2D(_MainTex, uv + fixed2(lineNoise * 0.005 * rng( 5.0), 0));
	    fixed4 col3 = tex2D(_MainTex, uv - fixed2(lineNoise * 0.005 * rng(31.0), 0));

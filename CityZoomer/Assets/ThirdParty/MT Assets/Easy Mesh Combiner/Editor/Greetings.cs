...
namespace MTAssets.EasyMeshCombiner.Editor
{
    ...
    class Greetings
    {
        ...
        public static string pathForThisAsset = "Assets/ThirdParty/MT Assets/Easy Mesh Combiner";
        ...
        public static string pathToGreetingsFile = "Assets/ThirdParty/MT Assets/_AssetsData/Greetings/GreetingsData.Emc.ini";
        ...
        public static void CreateBaseDirectoriesIfNotExists()
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/ThirdParty/MT Assets/_AssetsData/Greetings"))
                AssetDatabase.CreateFolder("Assets/ThirdParty/MT Assets/_AssetsData", "Greetings");
        }
